...
<head>
  ...
  <title>NETAJI SUBHAS UNIVERSITY | Add Subjects</title>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <select class="form-control" name="course_id" id="course_id" onchange="showdesg(this.value)" required>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <select class="form-control" onchange="" id="session_id" name="academic_year">
