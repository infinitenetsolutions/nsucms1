                                                                            ...
                                                                            <div class="card-body pl-5 pr-5">
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-sm-6">
                                                                                        ...
                                                                                        <div class="form-group clearfix">
                                                                                            <div class="icheck-warning d-inline">
                                                                                                <input type="checkbox" id="checkboxPrimary5_11<?php echo $row["admin_id"]; ?>" name="permission_7[]" value="7_13" <?php if (isset($autority)) {
                                                                                                                                                                                                                        $page_no_temp = 7;
                                                                                                                                                                                                                        $flag = 0;
                                                                                                                                                                                                                        if (isset($allAutority->$page_no_temp)) {
                                                                                                                                                                                                                            $subMenus = explode("||", $allAutority->$page_no_temp);
                                                                                                ...
                                                                                                <label for="checkboxPrimary5_11<?php echo $row["admin_id"]; ?>">Print</label>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
