                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input disabled type="text" name="add_admission_no" class="form-control" value="<?php echo 'NSU/' . $admission_course_name . '/' . trim($admission_session) . '/' . $max_value ?>" readonly placeholder="Generate By University">
                                    </div>
